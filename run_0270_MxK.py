...
index_output_path = '.MxK.bgwas'
records_output_path = 'MxK/records'
records_filename = 'MxK'
...
num_timepoints = lab.biotools.snapshot2bgwas(snapshot_info_path,
                                             ...
                                             prefix="RGB SV1",
                                             barcode_regex='^([A-Za-z]+)(\d+)([A-Z])\d+.*$',
                                             treatments={
                                                 "C": 0,
                                                 "S": 1
                                             },
                                             not_before=datetime.datetime.strptime('2015-05-08', '%Y-%m-%d'))
